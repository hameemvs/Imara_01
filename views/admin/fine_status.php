...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        ...
        <div class="col-4 text-end">
            ...
            <a href="<?= url('views/admin/fine.php') ?>" class="btn btn-dark">Back to Fine</a>
        </div>
    </div>
        ...
        <div class="container">
            <form id="fine_status_form" action="<?= url('services/ajax_functions.php') ?>">
                <div class="row">
                    ...
                    <!-- <input type="hidden" name="id" value="<?= $Borrowed_Books['FineStatus']; ?>"> -->
                    <input type="hidden" name="action" value="Borrowed_Books_update">
                    <div class=" mb-3 col-6">
                                <label for="fine" class="form-label">fine</label>
                                <input type="text" class="form-control"   value="<?= $Borrowed_Books['FineAmount']; ?>"  name="book_status" readonly>

                            </div>
           
                            <div class=" mb-3 col-6">
                                <label for="fine_status" class="form-label">Fine Status:</label>
                                <select class="form-select" id="Paid_status" aria-label="Default select example" name="Paid_status" value="<?= $Borrowed_Books['fine_status']; ?>"  required>
